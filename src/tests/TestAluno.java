...
class TestAluno {
	...
	@Test
	void testAdicionarDisciplinaAoAluno() {
		Aluno.adicionarDisciplinaAoAluno(a1, d1);
		Disciplina valorAtual = a1.listaDeDisciplinasDoAluno.get(0);			
		assertEquals(d1, valorAtual);
	}

	@Test
	void testDisciplinasDoAluno() {
		Aluno.adicionarDisciplinaAoAluno(a2, d1);
		Aluno.adicionarDisciplinaAoAluno(a2, d2);
		Aluno.adicionarDisciplinaAoAluno(a2, d3);
		
		int valorAtual = a2.listaDeDisciplinasDoAluno.size();
		assertEquals(3, valorAtual);
		
		
	}

	@Test
	void testHorariosDoAluno() {
		Aluno.adicionarDisciplinaAoAluno(a3, d1);
		String valorAtual = d1.getHorario();
		assertEquals("07:00", valorAtual);
